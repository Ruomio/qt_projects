...
#include <memory>
#include "../../../XVideoEdit/src/xvideothread.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_XVideoThread_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_XVideoThread_t qt_meta_stringdata_XVideoThread = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_XVideoThread[] = {
...
Q_CONSTINIT const QMetaObject XVideoThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_XVideoThread.offsetsAndSizes,
    qt_meta_data_XVideoThread,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_XVideoThread_t,
        // Q_OBJECT / Q_GADGET
