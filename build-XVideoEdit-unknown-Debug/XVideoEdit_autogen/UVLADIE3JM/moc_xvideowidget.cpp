...
#include <memory>
#include "../../../XVideoEdit/src/xvideowidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_XVideoWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_XVideoWidget_t qt_meta_stringdata_XVideoWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_XVideoWidget[] = {
...
Q_CONSTINIT const QMetaObject XVideoWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_XVideoWidget.offsetsAndSizes,
    qt_meta_data_XVideoWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_XVideoWidget_t,
        // Q_OBJECT / Q_GADGET
